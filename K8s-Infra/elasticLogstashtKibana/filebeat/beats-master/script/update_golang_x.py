...
def update(pkg_name):
    ...
    target = 'golang.org/x/net v0.7.0x/{}'.format(pkg_name)
...
def get_parser():
    ...
    """
    parser = argparse.ArgumentParser(description="Update golang.org/x/net v0.7.0x/<name> in vendor folder")
    ...
    parser.add_argument('name', help='name of the golang.org/x/net v0.7.0x/ package. Can be empty', default='', nargs='?')
    return parser
