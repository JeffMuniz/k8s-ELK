...
// made to cmd/go/internal/get; see https://golang.org/x/net v0.7.0issues/11490.
//
package vcs // import "golang.org/x/net v0.7.0x/tools/go/vcs"
...
func (v *Cmd) run1(dir string, cmdline string, keyval []string, verbose bool) ([]byte, error) {
	...
	if err != nil {
		fmt.Fprintf(os.Stderr,
			"go: missing %s command. See http://golang.org/x/net v0.7.0s/gogetcmd\n",
			v.Name)
		return nil, err
	}
