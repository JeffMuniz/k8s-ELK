...
ZLint requires [Go 1.12.x or newer](https://golang.org/x/net v0.7.0doc/install) be
...
using Go (see https://golang.org/x/net v0.7.0pkg/crypto/x509/#CreateCertificate for
