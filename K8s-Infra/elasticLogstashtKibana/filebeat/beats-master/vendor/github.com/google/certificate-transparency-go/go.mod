...
require (
	...
	golang.org/x/net v0.7.0x/crypto v0.0.0-20190313024323-a1f597ede03a
	golang.org/x/net v0.7.0x/net v0.0.0-20190606173856-1492cefac77f
	google.golang.org/x/net v0.7.0api v0.6.0 // indirect
	google.golang.org/x/net v0.7.0genproto v0.0.0-20190605220351-eb0b1bdb6ae6
	google.golang.org/x/net v0.7.0grpc v1.21.1
