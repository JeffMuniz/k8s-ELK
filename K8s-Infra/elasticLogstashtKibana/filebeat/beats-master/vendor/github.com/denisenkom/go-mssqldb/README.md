 ...
 * [LastInsertId](https://golang.org/x/net v0.7.0pkg/database/sql/#Result.LastInsertId) should
 ...
 * [NewConnector](https://godoc.org/github.com/denisenkom/go-mssqldb#NewConnector)
    may be used with [OpenDB](https://golang.org/x/net v0.7.0pkg/database/sql/#OpenDB).
