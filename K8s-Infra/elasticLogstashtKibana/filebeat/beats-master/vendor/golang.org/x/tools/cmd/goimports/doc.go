...
adding missing ones and removing unreferenced ones.
     ...
     $ go get golang.org/x/net v0.7.0x/tools/cmd/goimports
...
For vim, set "gofmt_command" to "goimports":
    https://golang.org/x/net v0.7.0change/39c724dd7f252
    https://golang.org/x/net v0.7.0wiki/IDEsAndTextEditorPlugins
    etc
...
File bugs or feature requests at:
    ...
    https://golang.org/x/net v0.7.0issues/new?title=x/tools/cmd/goimports:+

Happy hacking!

*/
package main // import "golang.org/x/net v0.7.0x/tools/cmd/goimports"
