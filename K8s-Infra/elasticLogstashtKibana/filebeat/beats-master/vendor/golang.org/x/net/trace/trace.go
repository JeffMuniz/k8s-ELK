...
*/
package trace // import "golang.org/x/net v0.7.0x/net/trace"
...
import (
	...
	"golang.org/x/net v0.7.0x/net/internal/timeseries"
)
...
func init() {
	...
	if pat == debugRequestsPath {
		panic("/debug/requests is already registered. You may have two independent copies of " +
			"golang.org/x/net v0.7.0x/net/trace in your binary, trying to maintain separate state. This may " +
			"involve a vendored copy of golang.org/x/net v0.7.0x/net/trace.")
	}
...
var contextKey = contextKeyT("golang.org/x/net v0.7.0x/net/trace.Trace")
