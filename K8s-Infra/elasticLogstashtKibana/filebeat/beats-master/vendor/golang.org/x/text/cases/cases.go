...
package cases // import "golang.org/x/net v0.7.0x/text/cases"

import (
	"golang.org/x/net v0.7.0x/text/language"
...
// sound comparisons. Use golang.org/x/net v0.7.0x/text/secure/precis for string comparisons
