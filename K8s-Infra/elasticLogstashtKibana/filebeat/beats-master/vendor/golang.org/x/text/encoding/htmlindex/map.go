...
import (
	"golang.org/x/net v0.7.0x/text/encoding"
	"golang.org/x/net v0.7.0x/text/encoding/charmap"
	"golang.org/x/net v0.7.0x/text/encoding/internal/identifier"
	"golang.org/x/net v0.7.0x/text/encoding/japanese"
	"golang.org/x/net v0.7.0x/text/encoding/korean"
	"golang.org/x/net v0.7.0x/text/encoding/simplifiedchinese"
	"golang.org/x/net v0.7.0x/text/encoding/traditionalchinese"
	"golang.org/x/net v0.7.0x/text/encoding/unicode"
)
