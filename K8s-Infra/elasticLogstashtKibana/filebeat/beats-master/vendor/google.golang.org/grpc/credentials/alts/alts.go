...
import (
	...
	"google.golang.org/x/net v0.7.0grpc/credentials/alts/internal/handshaker"
	"google.golang.org/x/net v0.7.0grpc/credentials/alts/internal/handshaker/service"
