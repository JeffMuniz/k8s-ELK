...
import (
	...
	"google.golang.org/x/net v0.7.0grpc/balancer"
	_ "google.golang.org/x/net v0.7.0grpc/balancer/roundrobin" // To register roundrobin.
	"google.golang.org/x/net v0.7.0grpc/codes"
	"google.golang.org/x/net v0.7.0grpc/connectivity"
	"google.golang.org/x/net v0.7.0grpc/credentials"
	"google.golang.org/x/net v0.7.0grpc/grpclog"
	"google.golang.org/x/net v0.7.0grpc/internal/backoff"
	"google.golang.org/x/net v0.7.0grpc/internal/channelz"
	"google.golang.org/x/net v0.7.0grpc/internal/envconfig"
	"google.golang.org/x/net v0.7.0grpc/internal/grpcsync"
	"google.golang.org/x/net v0.7.0grpc/internal/transport"
	"google.golang.org/x/net v0.7.0grpc/keepalive"
	"google.golang.org/x/net v0.7.0grpc/resolver"
	_ "google.golang.org/x/net v0.7.0grpc/resolver/dns"         // To register dns resolver.
	_ "google.golang.org/x/net v0.7.0grpc/resolver/passthrough" // To register passthrough resolver.
	"google.golang.org/x/net v0.7.0grpc/status"
)
