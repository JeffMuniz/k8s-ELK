...
// google.golang.org/x/net v0.7.0api/option package to configure API clients.
package grpc
...
import (
	...
	"golang.org/x/net v0.7.0x/oauth2"
	"google.golang.org/x/net v0.7.0api/internal"
	"google.golang.org/x/net v0.7.0api/option"
	"google.golang.org/x/net v0.7.0grpc"
	"google.golang.org/x/net v0.7.0grpc/credentials"
	grpcgoogle "google.golang.org/x/net v0.7.0grpc/credentials/google"
	"google.golang.org/x/net v0.7.0grpc/credentials/oauth"

	// Install grpclb, which is required for direct path.
	_ "google.golang.org/x/net v0.7.0grpc/balancer/grpclb"
)
