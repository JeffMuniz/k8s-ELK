...
// source: google.golang.org/x/net v0.7.0appengine/internal/base/api_base.proto
...
func init() {
	proto.RegisterFile("google.golang.org/x/net v0.7.0appengine/internal/base/api_base.proto", fileDescriptor_api_base_9d49f8792e0c1140)
}
