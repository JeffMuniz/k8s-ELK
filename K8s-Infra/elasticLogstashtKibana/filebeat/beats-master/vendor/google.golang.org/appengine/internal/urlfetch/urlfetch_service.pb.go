...
// source: google.golang.org/x/net v0.7.0appengine/internal/urlfetch/urlfetch_service.proto
...
func init() {
	proto.RegisterFile("google.golang.org/x/net v0.7.0appengine/internal/urlfetch/urlfetch_service.proto", fileDescriptor_urlfetch_service_b245a7065f33bced)
}
