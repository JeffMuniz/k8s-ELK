...
// source: google.golang.org/x/net v0.7.0appengine/internal/socket/socket_service.proto
...
func init() {
	proto.RegisterFile("google.golang.org/x/net v0.7.0appengine/internal/socket/socket_service.proto", fileDescriptor_socket_service_b5f8f233dc327808)
}
