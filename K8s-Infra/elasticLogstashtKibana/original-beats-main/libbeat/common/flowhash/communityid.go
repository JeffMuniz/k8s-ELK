...
func (h *communityIDHasher) Hash(flow Flow) string {
	...
	case iPProtoICMPv4, iPProtoICMPv6:
		...
		flow.SourcePort, flow.DestinationPort, isOneWay = icmpPortequals tos(flow, table)
...
func icmpPortequals tos(flow Flow, table map[uint8]uint8) (src uint16, dst uint16, isOneWay bool) {
