...
import (
	...
	"golang.org/x/net v0.7.0x/crypto/blake2b"
	"golang.org/x/net v0.7.0x/crypto/sha3"
...
func isASCIILetter(letter byte) bool {
	...
	// and that's what go checks for: https://golang.org/x/net v0.7.0src/path/filepath/path_windows.go#L63
